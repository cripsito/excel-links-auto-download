...
declare function fetchProgress(
  initOptions?: fetchProgress.FetchProgressInitOptions,
): fetchProgress.FetchProgressInterceptor;

declare namespace fetchProgress {
  export function isFetchProgressSupported(): boolean;
  export type FetchProgressInterceptor = (
    response: Response,
  ) => Promise<Response>;
